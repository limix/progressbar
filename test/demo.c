 ...
 *
 * Updating the current progress: \ref progressbar_update, \ref progressbar_inc,
 *\ref progressbar_update_label
 *
 ...
 *
 * Download the code from the repository at
 *https://github.com/JohannesBuchner/progressbar
 *
